...
#define TEST_FILE_NAME "test2.txt"
...
SdmmcHandler   sd __attribute__((section(".sdram_bss")));
FatFSInterface fsi __attribute__((section(".sdram_bss")));
FIL            SDFile __attribute__((section(".sdram_bss")));
...
int main(void)
{
    ...
    {
        // asm("bkpt 255");
        hw.PrintLine("failcnt: %d", failcnt);
    }
